    ...
    pub fn loadGame(&mut self) {
        match self.index {
            ...
            61 => {
                ...
                self.mask[7] = 0b0001000000;

                self.negativeMask[6] = 0b0011100000;
                self.negativeMask[7] = 0b0010100000;
                self.negativeMask[8] = 0b0011100000;
            }
            ...
            62 => {
                ...
                self.mask[3] = 0b0000001000;
                self.mask[4] = 0b0000001000;

                self.negativeMask[2] = 0b0000010100;
                self.negativeMask[3] = 0b0000010100;
                self.negativeMask[4] = 0b0000010100;
                self.negativeMask[5] = 0b0000011100;
            }
            ...
            63 => {
                ...
                self.mask[4] = 0b0010000000;

                self.negativeMask[3] = 0b0111000000;
                self.negativeMask[4] = 0b0101000000;
                self.negativeMask[5] = 0b0111000000;
            }
            ...
            64 => {
                ...
                self.mask[8] = 0b0000001000;
                self.mask[9] = 0b0000001000;

                self.negativeMask[7] = 0b0000011100;
                self.negativeMask[8] = 0b0000010100;
                self.negativeMask[9] = 0b0000010100;
            }
            ...
            65 => {
                ...
                self.mask[8] = 0b0100000000;

                self.negativeMask[7] = 0b1110000000;
                self.negativeMask[8] = 0b1010000000;
                self.negativeMask[9] = 0b1110000000;
            }
           ...
           66 => {
                ...
                self.negativeMask[7] = 0b0000000010;
                self.negativeMask[8] = 0b0000000000;
                self.negativeMask[9] = 0b0000000010;
            }
           ...
           67 => {
                ...
                self.mask[7] = 0b1000000000;

                self.negativeMask[6] = 0b1100000000;
                self.negativeMask[7] = 0b0100000000;
                self.negativeMask[8] = 0b0100000000;
            }
           ...
           68 => {
                ...
                self.negativeMask[0] = 0b0001010000;
                self.negativeMask[1] = 0b0001110000;
            }
           ...
           69 => {
                ...
                self.mask[6] = 0b0000000110;

                self.negativeMask[5] = 0b0000001111;
                self.negativeMask[6] = 0b0000001000;
                self.negativeMask[7] = 0b0000001111;
            }
